...
curl -L -o data/MIRACL_Processed_cnn_features.zip -b cookies.txt "https://drive.google.com/uc?export=download&confirm=$(awk '/download/ {print $NF}' cookies.txt)&id=1TcPVwcGcFFi98_oNZJBJNUnRii4qCRwx"
rm cookies.txt
