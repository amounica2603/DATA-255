...
\and
\IEEEauthorblockN{3\textsuperscript{rd} Mythri}
\IEEEauthorblockA{\textit{dept. MSDA} \\
%\textit{name of organization (of Aff.)}\\
San Jose, CA \\
...
\begin{figure}[htbp]
\centerline{\includegraphics[scale=0.35]{Project_flow.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[scale=0.35]{DATASET.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[scale=0.35]{LSTM_ARCHI.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[scale=0.35]{SelfAttention+FC.png}}
...
\begin{figure}[htbp]
\centerline{\includegraphics[scale=0.35]{Evaluation.png}}
